<?php
$CONFIG = '{"lang":"en","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":false,"theme":"light"}'; $use_auth = true; $auth_users = array('admin' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', 'user' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO'); $readonly_users = array('user'); $use_highlightjs = true; $highlightjs_style = 'vs'; $edit_files = true; $default_timezone = 'Etc/UTC'; $root_path = $_SERVER['DOCUMENT_ROOT']; $root_url = ''; $http_host = $_SERVER['HTTP_HOST']; $directories_users = array(); $iconv_input_encoding = 'UTF-8'; $datetime_format = 'd.m.y H:i:s'; $allowed_file_extensions = ''; $allowed_upload_extensions = ''; $favicon_path = ''; $exclude_items = array(''); $online_viewer = 'google'; $sticky_navbar = true; $max_upload_size_bytes = 5000; $ip_ruleset = 'OFF'; $ip_silent = true; $ip_whitelist = array('127.0.0.1', '::1'); $ip_blacklist = array('0.0.0.0', '::');  define('VERSION', '2.4.6'); define('APP_TITLE', 'Sab3 File Manager'); define('MAX_UPLOAD_SIZE', $max_upload_size_bytes);
...
function lng($txt) {
    ...
    $tr['en']['AppName']        = 'Sab3 File Manager';      $tr['en']['AppTitle']           = 'Sab3 File Manager';
